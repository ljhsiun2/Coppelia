    ...
    with open("testcases.csv") as f:
        ...
        for c in content:
			...
			print "parts[i]: ", parts[i]
                        print "rstValues: ", rstValues
                        if parts[i]:
                            if (int(parts[i], 16) != int(rstValues[i-input_no])):
                                notResetList.append([nameList[i], int(parts[i], 16)])
...
os.system('python2 multi/genRst.py -f '+starting_fsm_nos+' -l 1')
...
# generate testbench
os.system('python2 multi/genTestBench.py -f '+starting_fsm_nos+' -l 1')
...
os.system('klee -emit-all-errors -max-memory=100000000 -libcxx --libc=uclibc --posix-runtime obj_dir/Vor1200_cpu.bc')
...
while 1:
    ...
    if errfiles:
        ...
        os.system('cp '+pcfile+' currfiles/test'+str(count)+'.kquery')
    ...
    # generate reset file
    os.system('python2 multi/genRst.py -l 0 -a '+assert_arg)
    os.system('verilator -O3 -Wall -language 1364-2001 --top-module or1200_cpu +incdir+../cores/or1200 -Mdir obj_dir -cc ../cores/or1200/*.v --exe tb_reset.cpp')
    os.system('make -j -C obj_dir/ -f Vor1200_cpu.mk Vor1200_cpu')
    os.system('obj_dir/Vor1200_cpu > rstValues.txt')

    os.system('python2 multi/genTestBench.py -l 0 -a '+assert_arg)
    if (regONLY == 1):
    ...
    os.system('make -j -C obj_dir/ -f Vor1200_cpu.mk Vor1200_cpu')
    os.system('extract-bc -l llvm-link obj_dir/Vor1200_cpu')
    os.system('klee -emit-all-errors -max-memory=100000000 --libc=uclibc --posix-runtime obj_dir/Vor1200_cpu.bc')
